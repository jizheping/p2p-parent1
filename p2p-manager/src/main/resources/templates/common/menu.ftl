<ul id="menu" class="list-group">
	...
	<li class="list-group-item">
		...
		<ul class="in" id="auditmanage_detail">
			...
			<li class=""><a href="/manager/bidrequest_publishaudit_list">发标前审核</a></li>
			<li class=""><a href="/manager/bidrequest_audit1_list">满标一审</a></li>
			<li class=""><a href="/manager/bidrequest_audit2_list">满标二审</a></li>
