...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-sm-9">
			...
			<form id="searchForm" class="form-inline" method="post" action="/manager/bidrequest_audit2_list">
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-body">
					<form class="form-horizontal" id="editform" method="post" action="/manager/publish_audit_two">
						<fieldset>
							<div id="legend" class="">
								<legend>满标二审</legend>
							</div>
