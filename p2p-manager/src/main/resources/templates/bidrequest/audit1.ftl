...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-sm-9">
			...
			<form id="searchForm" class="form-inline" method="post" action="/manager/bidrequest_audit1_list">
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-body">
					<form class="form-horizontal" id="editform" method="post" action="/manager/publish_audit_one">
						<fieldset>
							<div id="legend" class="">
								<legend>满标一审</legend>
							</div>
